        ...
        <div className="flex flex-col sm:flex-row items-center gap-10">
          ...
          <div className="w-full sm:w-[60%]">
            ...
            {/* <p className="text-gray-600">
              Whether you're planning a romantic getaway, a family adventure, or a corporate retreat, TL Tours is your partner in creating unforgettable travel experiences.
            </p> */}
          </div>
        </div>
      </div>
